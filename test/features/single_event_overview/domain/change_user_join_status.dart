...
void main() {
  ...
  ChangeUserJoinStatus checkIsUserJoined;
  String tEventId;
  ...
  setUp(() {
    ...
    userEventsRepositoryMock = UserEventsRepositoryMock();
    checkIsUserJoined =
        ChangeUserJoinStatus(userEventsRepository: userEventsRepositoryMock);
  ...
  group("no errors", () {
    test("should make a call to userEventsRepository", () async {
      ...
      await checkIsUserJoined(tEventJoinData);
    ...
    test("should return true if repo returns true", () async {
      when(userEventsRepositoryMock.checkIsUserJoined(any))
          .thenAnswer((realInvocation) async => Right(true));
      final response = await checkIsUserJoined(tEventJoinData);
